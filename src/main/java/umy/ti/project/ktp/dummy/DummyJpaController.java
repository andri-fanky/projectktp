...
import umy.ti.project.ktp.dummy.exceptions.NonexistentEntityException;
import umy.ti.project.ktp.dummy.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("umy.ti_project.ktp_jar_0.0.1-SNAPSHOTPU");
